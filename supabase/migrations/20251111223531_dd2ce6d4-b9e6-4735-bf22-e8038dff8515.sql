-- Verificar e corrigir a função complete_quiz
-- Garantir que ela retorna TODOS os campos necessários
...
BEGIN
  ...
  FROM quiz_answers
  WHERE quiz_answers.attempt_id = complete_quiz.attempt_id AND is_correct = true;
