...
export function AdminUserManagement({ users, adminId, onSuccess, userType }: AdminUserManagementProps) {
  ...
  const getUserTypeLabel = (type: string) => {
    switch (type) {
      case 'student': return 'Estudantes';
  ...
  return (
    <div className="space-y-6 mt-8">
      <div>
        <h4 className="text-lg font-semibold mb-4">Gerenciamento Administrativo - {getUserTypeLabel(userType)}</h4>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Dê ou retire moedas dos {getUserTypeLabel(userType).toLowerCase()}
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Mude o papel dos {getUserTypeLabel(userType).toLowerCase()}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
